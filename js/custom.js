(function() {
	...
	var app = {
		...
		appendBtnTop: function() {
			...
			$("body").append('<div class="btn-top"><svg class="btn-icon-right" viewBox="0 0 26 18 " width="26" height="18" style="color:#2c7ae7"><use xlink:href="images/arrow.svg#src-3"></use></svg></div>');
